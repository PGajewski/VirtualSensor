...
public class FuzzyOpeningLevel extends FuzzyVariable<FuzzyOpeningLevelValue, Float> {
	
	//Membership functions.

	FuzzyOpeningLevel(Float setMin, Float setMax)
	{
		initVariable(FuzzyOpeningLevelValue.values());
		/*
