...
public final class FuzzyPressure extends FuzzyVariable<FuzzyPressureValue, Float> {
		

	FuzzyPressure(Float setMin, Float setMax)
	{

		initVariable(FuzzyPressureValue.values());
		/*
